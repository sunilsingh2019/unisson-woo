...
//variation name removed from here
		// wc_display_item_meta(
		// 	$item,
		// 	array(
		// 		'label_before' => '<small class="wc-item-meta-label" style="float: ' . esc_attr( $text_align ) . '; margin-' . esc_attr( $margin_side ) . ': .25em; clear: both">',
		// 	)
		// );
//end variation removed
		// allow other plugins to add additional product information here.
