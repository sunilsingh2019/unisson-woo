    ...
    <div class="container">
        <div class="accountlogin">
            <form method="post" class="woocommerce-ResetPassword lost_reset_password">
                ...
                <div class="formfield woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
                ...
                <div class="formfield woocommerce-form-row form-row">
                    <input type="hidden" name="wc_reset_password" value="true" />
                    <button type="submit" class="btn btn-orange woocommerce-Button button"
