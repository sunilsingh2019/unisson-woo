...
<?php 
	...
	$thwmscf_title_order_details = !empty($thwmscf_settings['title_order_details']) ? wptexturize($thwmscf_settings['title_order_details']) : "Review order";
	$thwmscf_title_confirm_order = !empty($thwmscf_settings['title_confirm_order']) ? wptexturize($thwmscf_settings['title_confirm_order']) : "Confirm order";
    		...
    		<li class="thwmscf-tab">
	        	<a href="javascript:void(0)" id="step-<?php echo $step_number; ?>" data-step="<?php echo $step_number; ?>">
	        		<?php if($thwmscf_layout == 'thwmscf_time_line_step') { ?>
	        			<span class="thwmscf-tab-label">
	        				<span class="thwmscf-index thwmscf-tab-icon"><?php echo $step_number; ?></span>
	        				<?php echo wp_kses_post(__($thwmscf_title_order_details, 'woo-multistep-checkout')); ?>
	        			</span>
	        		<?php } else {
	        			echo wp_kses_post(__($thwmscf_title_order_details, 'woo-multistep-checkout')); 
	        		} ?>
	        	</a>
	        </li>	
