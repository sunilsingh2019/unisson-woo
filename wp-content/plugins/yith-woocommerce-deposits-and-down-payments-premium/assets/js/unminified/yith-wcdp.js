            ...
            if (deposit_shipping.length) {
                ...
                $.ajax({
                    ...
                    data      : {
                        ...
                        action    : yith_wcdp.actions.calculate_shipping.name,
                        nonce     : yith_wcdp.actions.calculate_shipping.nonce
                    },
                    dataType  : 'json',
                    method    : 'post',
    ...
    form_cart
            ...
            if( yith_wcdp.ajax_variations ){
                xhr = $.ajax({
                    ...
                    data: {
                        ...
                        variation_attr: form_cart.find( '.variations select' ).serializeArray().reduce( ( a, v ) => { a[ v.name ] = v.value;  return a; }, {} ),
        ...
        .on( 'click', '#yith-wcdp-add-deposit-to-cart button[name="calc_shipping"]', function(ev){
            ...
            $.ajax({
                ...
                data      : {
                    action: yith_wcdp.actions.change_location.name,
                    nonce: yith_wcdp.actions.change_location.nonce,
